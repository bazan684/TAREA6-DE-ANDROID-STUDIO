package com.example.agendalite.basededatos;
...
import android.content.ContentValues;
    ...
    import com.example.agendalite.entidad.Contactos;
   ...
   public class DbContactos extends DbHelper {
       ...
       Context context;
        ...
        public ArrayList<Contactos> mostrarContactos() {
            ...
            cursorContactos = db.rawQuery(
                    "SELECT * FROM " + TABLE_CONTACTOS +
        ...
        public Contactos verContacto(int id) {
            ...
            cursorContactos = db.rawQuery("SELECT * FROM " + TABLE_CONTACTOS
